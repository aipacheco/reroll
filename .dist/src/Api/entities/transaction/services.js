...
const createTransaction = (body, buyerId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { data, sellerEmail, buyerAdress, error, gameName } = yield Repository.createTransaction(body, buyerId);
        if (error) {
            return { error };
        }
        const emailResult = yield (0, utils_1.sendEmailToSeller)(sellerEmail, buyerAdress, gameName);
